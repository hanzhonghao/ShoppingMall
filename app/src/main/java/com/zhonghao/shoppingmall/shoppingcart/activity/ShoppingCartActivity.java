package com.zhonghao.shoppingmall.shoppingcart.activity;
...
import com.zhonghao.shoppingmall.app.MainActivity;
...
public class ShoppingCartActivity extends Activity implements View.OnClickListener {
    ...
    private void showData() {
        ...
        if (datas != null && datas.size() > 0) {
            tvShopcartEdit.setVisibility(View.VISIBLE);
            ll_empty_shopcart.setVisibility(View.GONE);
            adapter = new ShoppingCartAdapter(this, datas, tvShopcartTotal, checkboxAll, cb_all);
